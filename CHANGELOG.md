...
### Python publisher relocation

* Move the Data Center-native Python application, specification and test suite to the
  standalone [`md2conf` tool](https://github.com/mdmcdonald/theunderclass/tree/main/tools/md2conf).
  This repository continues to host the legacy Obsidian plugin.
